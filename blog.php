		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 post-list">
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg="img/course/10.png"></div>
						<div class="post-content">
							<h3><a href="single-blog.html">What is SAP?</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
							<p>SAP stands for Systems Applications and Products in Data Processing. SAP, by definition, is also name of the ERP (Enterprise Resource Planning) software as well the name of the company.
...
Other Competitive products of SAP Software in the market are  Oracle, Microsoft Dynamics, etc.</p>
						</div>
					</div>
					...
					<div class="post-item">
						...
						<div class="post-content">
							<h3><a href="single-blog.html">What Is Digital Marketing?</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
				...
				<div class="col-sm-8 col-md-5 col-lg-4 col-xl-3 offset-xl-1 offset-0 pl-xl-0 sidebar">
					...
					<div class="widget">
						...
						<div class="recent-post-widget">
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="img/course/10.png"></div>
							...
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="img/blog/3.jpg"></div>
								<div class="rp-content">
					...
					<div class="widget">
						...
						<div class="tags">
							<a href="#">Website Designing Course</a>
							<a href="#">Wordpress Training</a>
							<a href="#">Digital Marketing</a>
							<a href="#">Salesforce Course</a>
							<a href="#">Graphics Designing Course</a>
							<a href="#">Matlab</a>
